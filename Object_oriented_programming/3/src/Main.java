...
public class Main {
    public static void main(String[] args) {
        ...
        encyclopedia.CreatePerson("CreatePerson", "Писатель", "Реформировал");

        Person copy = new Person("copy", "careerCopy", "descriptionCopy");
        encyclopedia.CreateCopies(copy, 5);
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "5":
                    painter1.showPaintersInfo();
                    painter2.showPaintersInfo();
                    painter3.showPaintersInfo();
                     break;
                case "6":
